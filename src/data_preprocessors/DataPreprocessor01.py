...
class DataPreprocessor(DataPreprocessorParent):
    ...
    def load_nerf_cached_batch(self, iter_num, indices_dict):
        ...
        rays_o[indices_mask_nerf] = self.preprocessed_data_dict['nerf_data']['rays_o'][indices_nerf]
        rays_d[indices_mask_nerf] = self.preprocessed_data_dict['nerf_data']['rays_d'][indices_nerf]
        view_dirs[indices_mask_nerf] = self.preprocessed_data_dict['nerf_data']['view_dirs'][indices_nerf]
        ...
        near[indices_mask_nerf] = self.preprocessed_data_dict['nerf_data']['near_array'][indices_nerf]
        far[indices_mask_nerf] = self.preprocessed_data_dict['nerf_data']['far_array'][indices_nerf]
        ...
        if self.ndc:
            ...
            rays_o_ndc[indices_mask_nerf] = self.preprocessed_data_dict['nerf_data']['rays_o_ndc'][indices_nerf]
            rays_d_ndc[indices_mask_nerf] = self.preprocessed_data_dict['nerf_data']['rays_d_ndc'][indices_nerf]
            near_ndc[indices_mask_nerf] = self.preprocessed_data_dict['nerf_data']['near_array_ndc'][indices_nerf]
            far_ndc[indices_mask_nerf] = self.preprocessed_data_dict['nerf_data']['far_array_ndc'][indices_nerf]
    ...
    def load_sparse_depth_cached_batch(self, indices_dict, batch_dict):
        ...
        return_dict['rays_o'][indices_mask_sd] = self.preprocessed_data_dict['nerf_data']['rays_o'][indices_sd]
        return_dict['rays_d'][indices_mask_sd] = self.preprocessed_data_dict['nerf_data']['rays_d'][indices_sd]
        return_dict['view_dirs'][indices_mask_sd] = self.preprocessed_data_dict['nerf_data']['view_dirs'][indices_sd]
        return_dict['pixel_id'][indices_mask_sd] = self.preprocessed_data_dict['nerf_data']['pixel_id'][indices_sd]
        return_dict['near'][indices_mask_sd] = self.preprocessed_data_dict['nerf_data']['near_array'][indices_sd]
        return_dict['far'][indices_mask_sd] = self.preprocessed_data_dict['nerf_data']['far_array'][indices_sd]
        ...
        if self.ndc:
            ...
            return_dict['rays_o_ndc'][indices_mask_sd] = self.preprocessed_data_dict['nerf_data']['rays_o_ndc'][indices_sd]
            return_dict['rays_d_ndc'][indices_mask_sd] = self.preprocessed_data_dict['nerf_data']['rays_d_ndc'][indices_sd]
            return_dict['near_ndc'][indices_mask_sd] = self.preprocessed_data_dict['nerf_data']['near_array_ndc'][indices_sd]
            return_dict['far_ndc'][indices_mask_sd] = self.preprocessed_data_dict['nerf_data']['far_array_ndc'][indices_sd]

            sparse_depths_ndc = -1 * torch.ones((indices.shape[0], 1)).to(self.device)
            sparse_depths_ndc[indices_mask_sd] = self.preprocessed_data_dict['sparse_depth_data']['depths_ndc'][indices_sd]
    ...
    def load_dense_depth_cached_batch(self, indices_dict, batch_dict):
        ...
        if self.ndc:
            ...
            dense_depths_ndc[indices_mask_nerf] = self.preprocessed_data_dict['dense_depth_data']['depth_values_ndc'][indices_nerf]
